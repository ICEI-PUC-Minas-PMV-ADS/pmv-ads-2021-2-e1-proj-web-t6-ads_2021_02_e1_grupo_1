...
| Objetivo do Teste     | Objetivo do Teste	Verificar a função de cadastro do cliente |
...
| Objetivo do Teste     | Objetivo do Teste	Verificar a função de cadastro do vendedor |
| Passos                | 1) Acessar o Navegador <br>2) Informar o endereço do Site <br>3) Visualizar a página principal <br>4) Clicar na opção "Cadastre sua loja" presente no cabeçalho do site|
